			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 article">
						...
						<form role="search" method="get" id="page_searchform" class="page_searchform" action="<?php echo get_settings('home'); ?>" _lpchecked="1">
						<div>
							<input type="text" name="s" id="page_search" value="Enter search keywords" onfocus="if (this.value == 'Enter search keywords') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Enter search keywords';}">
							<input type="submit" id="page_searchsubmit" value="&#xf002;" title="Search" class="fa fa-search">
						</div>
						</form>					
